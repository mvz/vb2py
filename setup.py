...
setup(name=APPLICATION_NAME,
      ...
      packages=["vb2py", "vb2py.test", "vb2py.sandbox", "vb2py.custom",
                "vb2py.plugins", "vb2py.targets"],
      package_dir = {
          APPLICATION_NAME: '.',
          'vb2py.targets': './vb2py/targets',
          'vb2py.plugins': './vb2py/plugins',
          'vb2py.custom': './vb2py/custom',
          },
      license="BSD",
      cmdclass = { 'install_data': smart_install_data},
      data_files=makeDataDirs(dataDirs=[".", "./test", "./vb", "./doc", "./sandbox", "./vb"]),
     )
